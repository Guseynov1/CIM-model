...
//        class1Individual.forEach(x -> {         // выводим индивидумов первого класса
...
//        OWLObjectPropertyAssertionAxiom owlPbjectProprtyAssertionAxiom = dataFactory.getOWLObjectPropertyAssertionAxiom(
//                objectProperty, owlNamedIndividual, individual);
//        AddAxiom addAxiom = new AddAxiom(ontology, owlPbjectProprtyAssertionAxiom);
//        manager.applyChange(addAxiom);
//    }
//
